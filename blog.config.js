...
const BLOG = {
  ...
  CONTACT_LINKEDIN: 'https://slashine.onl/@BadR0Mance15', // 你的linkedIn 首页
  ...
  // 作废配置
  AVATAR: '/太子.png', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Daniel & NIC FEVER', // 站点标题 ，被notion中的页面标题覆盖
